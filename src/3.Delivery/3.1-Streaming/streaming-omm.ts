...
(async () => {
    try {
        ...
        ommStreamEUR.on(Delivery.OMMStream.Event.Refresh, (data) => console.log('EUR Refresh:', data));
        ommStreamEUR.on(Delivery.OMMStream.Event.Update, (data) => console.log('EUR Update:', data));
        ommStreamEUR.on(Delivery.OMMStream.Event.Status, (data) => console.log('EUR Status:', data));
        ommStreamEUR.on(Delivery.OMMStream.Event.Complete, (stream) => console.log('EUR Complete'));
        ...
        ommStreamCAD.on(Delivery.OMMStream.Event.Refresh, (data) => console.log('CAD Refresh:', data));
        ommStreamCAD.on(Delivery.OMMStream.Event.Update, (data) => console.log('CAD Update:', data));
        ommStreamCAD.on(Delivery.OMMStream.Event.Status, (data) => console.log('CAD Status:', data));
        ommStreamCAD.on(Delivery.OMMStream.Event.Complete, (stream) => console.log('CAD Complete'));
